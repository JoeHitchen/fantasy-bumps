...
class Test__Has_All_Seats(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.crew = models.Crew(gender = genders.MENS, rank = 1)
        cls.crew.save()
...
class Test__All_Investments(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.crew_hert = models.Crew.objects.get(name = 'Hertford', gender = genders.WOMENS)
        cls.crew_orie = models.Crew.objects.get(name = 'Oriel', gender = genders.WOMENS)
        cls.crew_wolf = models.Crew.objects.get(name = 'Wolfson', gender = genders.WOMENS)
