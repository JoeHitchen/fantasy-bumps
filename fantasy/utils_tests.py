...
class Test__Payouts(TestCase):
    ...
    def test__individual__row_over(self):
        ...
        old_price = utils.pricing_by_day_and_gender(old_ranking, self.day, Genders.WOMEN.value)
        new_price = utils.pricing_by_day_and_gender(new_ranking, self.day, Genders.WOMEN.value)
